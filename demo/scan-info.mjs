...
const lines = [
  ...
  "",
  "How it runs in production: weekly, via a GitHub Actions cron, with",
  "the cache reused across runs so each weekly pass only re-fetches",
  "the repos that changed in the past week.",
  "",
  "The real command:",
  "",
  "  auro version-scan",
