...
export async function buildWithRollup(options) {
  ...
  try {
    ...
    // This line does the same as buildMainBundle, buildTypeDefinitions - but in watch mode
    const watcherConfig = getWatcherConfig(mainBundleConfig, mainOutputConfig);
